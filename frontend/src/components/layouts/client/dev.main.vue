    ...
    <div class="navbar py-3 border-b-[#f5f6fb] fixed border-b-2 left-0 top-0 right-0 z-50  bg-white text-dark">
      <div class="lg:px-7 px-3 flex items-center">
          ...
          <div class="ms-auto items-center gap-5 lg:flex hidden">
              ...
              @mouseenter="showPostNav = true, showNotificationNav = false, VisibleProfileMenu = false" @blur="showPostNav = false" >
              ...
              @mouseenter="showNotificationNav = true, showPostNav = false, VisibleProfileMenu = false" @blur="showNotificationNav = false">
                  <div class="cursor-pointer">  
                      <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button v-if="!authStores.currentUser" @click="VisibleLoginDialog = true" class="cursor-pointer">
